...
(synth-fun f ((_arg_0 String)) Int
    ...
    ((Start Int (ntInt))
    (ntString String (_arg_0 "a" "b" "c" "d" "e" "f" (str.++ ntString ntString) (str.replace ntString ntString ntString) (str.at ntString ntInt)  (ite ntBool ntString ntString) (str.substr ntString ntInt ntInt)))
...
(constraint (= (f "Stately, plump Buck Mulligan came from the stairhead,") 13))
(constraint (= (f "bearing a bowl of lather on which a mirror and a razor lay crossed.") 18))
...
(constraint (= (f "Solemnly he came forward and mounted the round gunrest.") 15))
(constraint (= (f "He faced about and blessed gravely thrice the tower, the surrounding land and the awaking mountains") 30))
(constraint (= (f "Then, catching sight of Stephen Dedalus") 10))
